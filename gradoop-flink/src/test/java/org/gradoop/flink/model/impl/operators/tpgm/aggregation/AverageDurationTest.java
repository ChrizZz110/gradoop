...
import static org.gradoop.common.model.impl.pojo.temporal.TemporalElement.DEFAULT_TIME_FROM;
import static org.gradoop.common.model.impl.pojo.temporal.TemporalElement.DEFAULT_TIME_TO;
 ...
 */
public class AverageDurationTest extends GradoopFlinkTestBase {
  ...
  public void testGetIncrementForTxTime() {
    ...
    TemporalElement testElement = getConfig().getTemporalGraphFactory().getVertexFactory()
      .createVertex();
  ...
  public void testWithAggregation() throws Exception {
    ...
    EPGMVertexFactory<TemporalVertex> vertexFactory = graphFactory.getVertexFactory();
    EPGMEdgeFactory<TemporalEdge> edgeFactory = graphFactory.getEdgeFactory();
